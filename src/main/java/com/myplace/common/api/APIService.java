package com.myplace.common.api;
...
public class APIService<T> {
    ...
    private ResponseEntity<T> callApiEndpoint(String url, HttpMethod httpMethod, HttpHeaders httpHeaders, Object body, ParameterizedTypeReference<T> typeRef) {
        return restTemplate.exchange(url, httpMethod, new HttpEntity<>(body, httpHeaders), typeRef);
    }
}
